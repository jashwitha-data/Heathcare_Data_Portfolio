...
* Identified the **common key (PAT_ENC_ID)** shared across tables
...
```
```qlik
//Filter Seconday tbale (Pat_Visit)
PAT_VISIT:
SELECT *
...
**Before:**
![Before Filtering](screenshots/before_filtering.png)

* Data mismatch across tables
* Inconsistent filtering results
* Irrelevant records appearing in analysis

**After:**
![After Filtering](screenshots/after_filtering.png)

* Applied consistent filtering using common keys
* Ensured only relevant data is loaded across all tables
